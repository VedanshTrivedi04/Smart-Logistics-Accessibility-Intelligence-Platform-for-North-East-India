...
Portal-wise, page-wise notes. Rules: `.agent/rules/memory-update.md`. Global log: `../memory.md`.

## public
- [public/auth-callback](portals/public/auth-callback.md) - Public / OIDC callback (`/auth/callback`)
- [public/home](portals/public/home.md) - Public / Route & Corridor Checker (`/public`)
- [public/landing](portals/public/landing.md) - Public / Landing page (/) (`/`)
- [public/login](portals/public/login.md) - Public / Sign in (`/login`)
...
- [field/report-new](portals/field/report-new.md) - Field / Report an incident (`/field/report/new`)
- [field/reports-id](portals/field/reports-id.md) - Field / Report status (`/field/reports/[id]`)
- [field/reports](portals/field/reports.md) - Field / My reports (`/field/reports`)
...
- [shared/backend-reporting-incidents](portals/shared/backend-reporting-incidents.md) - Shared / Backend: reporting and incidents
- [shared/backend-routing](portals/shared/backend-routing.md) - Shared / Backend: routing
- [shared/backend-telemetry](portals/shared/backend-telemetry.md) - Shared / Backend: telemetry
- [shared/features-coordination-regions](portals/shared/features-coordination-regions.md) - Shared / Feature: coordination and regions (added 2026-09-24)
- [shared/features-fleet](portals/shared/features-fleet.md) - Shared / Feature: fleet
- [shared/features-hazard-impact-alerts](portals/shared/features-hazard-impact-alerts.md) - Shared / Features: hazard, impact, alerts, overview, analytics
- [shared/features-incidents](portals/shared/features-incidents.md) - Shared / Feature: incidents and reports
- [shared/features-network](portals/shared/features-network.md) - Shared / Feature: network (roads and facilities)
- [shared/features-routing](portals/shared/features-routing.md) - Shared / Feature: routing
- [shared/forbidden](portals/shared/forbidden.md) - Shared / Not permitted (`/forbidden`)
- [shared/infra-deploy](portals/shared/infra-deploy.md) - Shared / Infra and deployment
- [shared/known-issues](portals/shared/known-issues.md) - Shared / Known issues (as of 2026-09-24)
- [shared/map](portals/shared/map.md) - Shared / Map layer
- [shared/nav-and-auth](portals/shared/nav-and-auth.md) - Shared / Navigation, session and access gating
- [shared/offline-sync](portals/shared/offline-sync.md) - Shared / Offline-first storage and sync
- [shared/status](portals/shared/status.md) - Shared / Service status (`/status`)
- [shared/testing](portals/shared/testing.md) - Shared / Testing and verification
- [shared/ui-kit](portals/shared/ui-kit.md) - Shared / UI kit
